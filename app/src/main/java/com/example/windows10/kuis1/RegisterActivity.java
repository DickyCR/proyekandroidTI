...
public class RegisterActivity extends AppCompatActivity {
    ...
    EditText username, email, password, confirmPassword; //membuat variable editText

    //Declaration TextInputLayout
    TextInputLayout txtUsername, txtEmail, txtPassword, txtConfirmPassword; //membuat variable text input layout

    //Declaration Button
    Button buttonRegister; //membuat variable button
